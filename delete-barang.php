...
if($mode=="edit")
{
	...
	$nama=$_POST['nama'];
	$jumlah=$_POST['jumlah'];
	$simpan=mysqli_query($con,"update barang set nama_barang='$nama', stok='$jumlah' where id_barang='$id'");
	if(!($simpan))
	{
...
else if($mode=="add")
{
	$nama=$_POST['nama'];
	$jumlah=$_POST['jumlah'];
	$simpan=mysqli_query($con,"insert into barang values ('','$nama','$jumlah')");
	if(!($simpan))
	{
