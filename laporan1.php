					...
					<div class="panel-body">
						<table data-toggle="table" data-url="tables/data1.json"  data-show-refresh="true" data-show-toggle="true" data-show-columns="true" data-search="true" data-select-item-name="toolbar1" data-pagination="false" data-sort-name="name" data-sort-order="asc">
						    ...
						    <tr>
						        ...
						        <th data-field="seater3" data-sortable="true">Satuan</th>
								<th data-field="seater2" data-sortable="true">Jumlah Stok</th>
							</tr>
							</thead>
							<tbody>
...
//---------------------------------------------- INSERT TABLE ------------------------------------------------------
							...
							$sqlbarang="select nama_barang,satuan,stok from barang order by nama_barang asc";				
							...
							echo '
							<tr>
						        <td data-field="name"  data-sortable="true">'.$namabrg.'</td>
						        <td data-field="seater3" data-sortable="true">'.$satuan.'</td>
								<td data-field="seater2" data-sortable="true">'.$stok.'</td>
						    </tr>';
