				...
				<div class="panel panel-default">
					...
					<div class="panel-body">
						<table data-toggle="table" data-url="tables/data1.json"  data-show-refresh="true" data-show-toggle="true" data-show-columns="true" data-search="true" data-select-item-name="toolbar1" data-pagination="true" data-sort-name="tgl" data-sort-order="desc">
							...
							<?php
//---------------------------------------------- INSERT TABLE ------------------------------------------------------
							$sqltrx="select t.id_transaksi,t.tgl_transaksi,t.jenis_transaksi,t.id_barang,t.jumlah,t.keterangan,b.nama_barang,b.satuan from transaksi t, barang b where t.id_barang=b.id_barang order by t.id_transaksi desc limit 0,100";				
