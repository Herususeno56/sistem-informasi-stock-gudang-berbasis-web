		...
		<div class="row">
			<div class="col-lg-12">
				<div class="panel panel-default">
					<div class="panel-heading"><a href="add-barang.php" class="btn btn-primary btn-md">Add Items</a></div>
					<div class="panel-body">
						<table data-toggle="table" data-url="tables/data1.json"  data-show-refresh="true" data-show-toggle="true" data-show-columns="true" data-search="true" data-select-item-name="toolbar1" data-pagination="false" data-sort-name="name" data-sort-order="asc">
						    ...
						    <tr>
						        ...
						        <th data-field="stock" data-sortable="true">Stok</th>
...
//---------------------------------------------- INSERT TABLE ------------------------------------------------------
							...
							<tr>
						        ...
						        <td data-field="stock" data-sortable="true">'.$databarang['stok'].'</td>
								<td data-field="action" data-sortable="true"><a href="edit-barang.php?id='.$databarang['id_barang'].'"><span class="glyphicon glyphicon-pencil" title="Edit"></a> &nbsp;&nbsp;<a href="save-barang.php?id='.$databarang['id_barang'].'&mode=delete"><span class="glyphicon glyphicon-remove" title="Delete"></span></a></td>
						    </tr>';
							}
//---------------------------------------------- INSERT TABLE ------------------------------------------------------							
							?>
